...
def grid():
    ...
    global selection1, election2,hold1,hold2
...
def continuecheck():
    ...
    if (len(length_check) == 0):#if all selects by the user
        ...
        print("Level 01 Succesfully Completed")
        print("To play the second round press Y")
...
def main():
    ...
    global current_time,end_time,maindisplay,cards,cards_copy, selection1, selection2,mainlist,mainlength_check,length_check, display, totaltime,remaintime,marks,choice
    global turncount1, turncount2, turncount3, turncount4, turncount5, turncount6, turncount7, turncount8, turncount9, turncount10, turncount11, turncount12
    ...
    print()
    print(' To play the game follow the instructions carefully. ')
    print('You have to select card number from the grid after the game starts')
    print(' If you matched a pair successfully you will be awarded 20 marks per match \n if you fail to match you will be loose 5 *(number of times match tile has been shown)')
    print()
